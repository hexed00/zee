-- Demore Hub | Hexed Edition by Emorce / Axion

local synversion = "1.0.0-HEXED"

-- Demore Hub icon (hexed) — image cache
local DEMORE_ICON_ASSET = "http://www.roblox.com/asset/?id=9483813933"
pcall(function()
	local b64 = ""
	local folder = "DemoreHub"
	...
	local ok, bin = pcall(b64decode, b64)
	if ok and bin and #bin > 100 then
		writefile(path, bin)
		if getcustomasset then
			DEMORE_ICON_ASSET = getcustomasset(path)
		elseif syn and syn.get_custom_asset then
			DEMORE_ICON_ASSET = syn.get_custom_asset(path)
		elseif getcustomasset == nil and isfile and isfile(path) then
			-- some executors accept rbxasset:// or file path via getasset
			if getsynasset then
				DEMORE_ICON_ASSET = getsynasset(path)
			end
		end
	end
end)
...
local G2L = {};
-- StarterGui.SynapseX
local __demoreParent = nil
pcall(function()
	if gethui then __demoreParent = gethui() end
end)
if not __demoreParent then
	pcall(function() __demoreParent = game:GetService("CoreGui") end)
end
if not __demoreParent then
	__demoreParent = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")
end
G2L["1"] = Instance.new("ScreenGui");
G2L["1"].Parent = __demoreParent;
G2L["1"]["Name"] = [[DemoreHub]];
...
G2L["2"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
G2L["2"]["Size"] = UDim2.new(0, 48, 0, 48);
...
G2L["3"]["Image"] = DEMORE_ICON_ASSET;
G2L["3"]["Size"] = UDim2.new(0, 32, 0, 32);
G2L["3"]["Position"] = UDim2.new(0.5, -16, 0.5, -16);
G2L["3"]["Name"] = [[ ]];
...
G2L["6"]["BackgroundColor3"] = Color3.fromRGB(28, 28, 32);
...
G2L["8"]["BackgroundColor3"] = Color3.fromRGB(18, 18, 22);
...
G2L["9"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["e"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
G2L["e"]["TextSize"] = 14;
...
G2L["e"]["BorderColor3"] = Color3.fromRGB(22, 22, 26);
G2L["e"]["Text"] = [[test.lua]];
...
G2L["f"]["BackgroundColor3"] = Color3.fromRGB(14, 14, 18);
...
G2L["10"]["BackgroundColor3"] = Color3.fromRGB(14, 14, 18);
...
G2L["11"]["BackgroundColor3"] = Color3.fromRGB(14, 14, 18);
...
G2L["12"]["BackgroundColor3"] = Color3.fromRGB(12, 12, 16);
...
G2L["17"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["1a"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["1e"]["Text"] = "Demore Hub - "..synversion;
...
G2L["1f"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["20"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["23"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["24"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["27"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["2b"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["2c"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["2f"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["30"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["33"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["37"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["38"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["3b"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["3c"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["3f"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["40"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["4a"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["4b"]["TextSize"] = 14;
G2L["4b"]["BackgroundColor3"] = Color3.fromRGB(14, 14, 18);
...
G2L["4c"]["BackgroundColor3"] = Color3.fromRGB(18, 18, 22);
G2L["4c"]["TextSize"] = 14;
...
G2L["4d"]["Image"] = DEMORE_ICON_ASSET;
...
G2L["4f"]["Active"] = true;
G2L["4f"]["Text"] = [[Demore Hub - Save File]];
G2L["4f"]["Name"] = [[Title]];
...
G2L["52"]["BackgroundColor3"] = Color3.fromRGB(28, 28, 32);
...
G2L["53"]["BackgroundColor3"] = Color3.fromRGB(16, 16, 20);
...
G2L["54"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["55"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 24);
G2L["55"]["TextSize"] = 14;
...
G2L["56"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
G2L["56"]["TextSize"] = 14;
...
G2L["57"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["58"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
G2L["58"]["TextSize"] = 14;
...
G2L["59"]["Image"] = DEMORE_ICON_ASSET;
...
G2L["5b"]["BackgroundColor3"] = Color3.fromRGB(24, 24, 28);
...
G2L["5c"]["BackgroundColor3"] = Color3.fromRGB(16, 16, 20);
...
G2L["5d"]["BackgroundColor3"] = Color3.fromRGB(10, 10, 14);
...
G2L["5e"]["BackgroundColor3"] = Color3.fromRGB(10, 10, 14);
G2L["5e"]["TextSize"] = 14;
...
G2L["5f"]["BackgroundColor3"] = Color3.fromRGB(10, 10, 14);
G2L["5f"]["TextSize"] = 14;
...
G2L["60"]["BackgroundColor3"] = Color3.fromRGB(10, 10, 14);
G2L["60"]["TextSize"] = 14;
...
G2L["61"]["BackgroundColor3"] = Color3.fromRGB(10, 10, 14);
G2L["61"]["TextSize"] = 14;
...
G2L["62"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 24);
G2L["62"]["TextSize"] = 14;
...
G2L["63"]["Text"] = [[Demore Hub - Script Hub]];
G2L["63"]["Name"] = [[Title]];
...
G2L["64"]["BackgroundColor3"] = Color3.fromRGB(10, 10, 14);
...
G2L["65"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 24);
G2L["65"]["TextSize"] = 14;
...
G2L["6e"]["Image"] = DEMORE_ICON_ASSET;
...
G2L["6f"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 24);
...
G2L["70"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 24);
G2L["70"]["TextSize"] = 14;
...
G2L["72"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["77"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
G2L["77"]["TextSize"] = 14;
...
G2L["7b"]["Image"] = DEMORE_ICON_ASSET;
...
G2L["80"]["Modal"] = true;
G2L["80"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
G2L["80"]["TextSize"] = 14;
...
G2L["81"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
G2L["81"]["TextSize"] = 14;
...
G2L["82"]["BackgroundColor3"] = Color3.fromRGB(18, 18, 22);
...
G2L["87"]["ZIndex"] = 7;
G2L["87"]["BackgroundColor3"] = Color3.fromRGB(16, 16, 20);
...
G2L["88"]["ZIndex"] = 7;
G2L["88"]["BackgroundColor3"] = Color3.fromRGB(16, 16, 20);
G2L["88"]["TextSize"] = 14;
...
G2L["89"]["ZIndex"] = 7;
G2L["89"]["BackgroundColor3"] = Color3.fromRGB(16, 16, 20);
G2L["89"]["TextSize"] = 14;
...
G2L["8a"]["ZIndex"] = 7;
G2L["8a"]["BackgroundColor3"] = Color3.fromRGB(16, 16, 20);
G2L["8a"]["TextSize"] = 14;
...
G2L["8b"]["BackgroundColor3"] = Color3.fromRGB(22, 22, 26);
...
G2L["8c"]["TextSize"] = 14;
G2L["8c"]["BackgroundColor3"] = Color3.fromRGB(14, 14, 18);
...
G2L["8d"]["BackgroundColor3"] = Color3.fromRGB(18, 18, 22);
G2L["8d"]["TextSize"] = 14;
...
G2L["8e"]["Image"] = DEMORE_ICON_ASSET;
...
G2L["90"]["Active"] = true;
G2L["90"]["Text"] = [[Demore Hub - Open File]];
G2L["90"]["Name"] = [[Title]];
...
local function C_49()
	local script = G2L["49"];
	local root = script.Parent.Parent -- ScreenGui DemoreHub
	local buttons = script.Parent -- Main
	local title = buttons:FindFirstChild("TitleSynapse") or buttons:FindFirstChild("TitleDemore")
	local injectedVal = root:FindFirstChild("Injected")
	local floating = root:FindFirstChild("FloatingIcon")

	local function isInjected()
		return injectedVal and injectedVal.Value == true
	end

	local function setInjected(v)
		if injectedVal then injectedVal.Value = v end
	end
	...
	local function GetTextbox()
		local folder = buttons:FindFirstChild("MainFunc")
		if not folder then return nil end
		folder = folder:FindFirstChild("Textboxes")
		if not folder then return nil end
		for _, textbox in pairs(folder:GetChildren()) do
			if textbox.Visible then
				return textbox
			end
		end
	...
	local function safeLoad(code)
		if not code or code == "" then
			setTitle("Demore Hub - "..synversion.." (empty script)")
			task.delay(1.2, function() setTitle("Demore Hub - "..synversion) end)
			return
		end
		local fn, err = loadstring(code)
		if not fn then
			setTitle("Demore Hub - compile error")
			warn("[Demore Hub] compile error:", err)
			task.delay(1.5, function() setTitle("Demore Hub - "..synversion) end)
			return
		end
		local ok, runtimeErr = pcall(fn)
		if not ok then
			setTitle("Demore Hub - runtime error")
			warn("[Demore Hub] runtime error:", runtimeErr)
			task.delay(1.5, function() setTitle("Demore Hub - "..synversion) end)
		end
	end
	...
	buttons.Clear.MouseButton1Up:Connect(function()
		local tb = GetTextbox()
		if tb and tb:FindFirstChild("Frame") and tb.Frame:FindFirstChild("Textbox") then
			tb.Frame.Textbox.Text = ""
		end
	end)

	-- Execute (always works once attached; attach is soft gate only)
	buttons.Execute.MouseButton1Up:Connect(function()
		if not isInjected() then
			setTitle("Demore Hub - "..synversion.." (not injected! press Attach)")
			task.delay(1.4, function() setTitle("Demore Hub - "..synversion) end)
			return
		end
		local textbox = GetTextbox()
		if not textbox then
			setTitle("Demore Hub - no editor tab")
			task.delay(1.2, function() setTitle("Demore Hub - "..synversion) end)
			return
		end
		local code = textbox.Frame.Textbox.Text
		setTitle("Demore Hub - executing...")
		task.spawn(function()
			safeLoad(code)
			task.wait(0.35)
			setTitle("Demore Hub - "..synversion)
		end)
	end)

	-- Attach (cosmetic inject sequence, then unlock execute)
	buttons.Attach.MouseButton1Up:Connect(function()
		if isInjected() then
			setTitle("Demore Hub - "..synversion.." (already injected!)")
			task.wait(1)
			setTitle("Demore Hub - "..synversion)
			return
		end
		setTitle("Demore Hub - "..synversion.." (checking...)")
		task.wait(0.5)
		setTitle("Demore Hub - "..synversion.." (injecting...)")
		task.wait(0.9)
		setTitle("Demore Hub - "..synversion.." (scanning...)")
		task.wait(0.6)
		setInjected(true)
		setTitle("Demore Hub - "..synversion.." (ready!)")
		task.wait(0.8)
		setTitle("Demore Hub - "..synversion)
	end)
	...
	buttons.Options.MouseButton1Up:Connect(function()
		local menu = root:FindFirstChild("OptionMenu")
		if menu then
	...
	local function collapseToWidget()
	...
	local function expandFromWidget()
		if floating then floating.Visible = false end
		buttons.Visible = true
	end

	buttons.Close.MouseButton1Up:Connect(collapseToWidget)
	buttons.Minimize.MouseButton1Up:Connect(collapseToWidget)
	buttons.Maximize.MouseButton1Up:Connect(function()
		-- toggle maximize-ish: just ensure expanded
		expandFromWidget()
	end)

	if floating then
		floating.MouseButton1Up:Connect(expandFromWidget)
		-- also allow drag already set elsewhere
	end

	-- Start expanded; floating hidden
	buttons.Visible = true
	if floating then floating.Visible = false end
	setTitle("Demore Hub - "..synversion)
end;
task.spawn(C_49);
-- StarterGui.SynapseX.SaveScript.HandlerSaveScript.Handler
local function C_51()
	local script = G2L["51"];
	script.Parent.savescript.MouseButton1Up:Connect(function()
		local module = require(script.Parent.Parent.Module)
		local name = script.Parent.scriptname.Text
		...
		local code = ""
		local active = module:GetActiveTextbox()
		if active and active:FindFirstChild("Frame") and active.Frame:FindFirstChild("Textbox") then
			code = active.Frame.Textbox.Text
		end
		pcall(function()
			if not isfolder("DemoreHubScripts") then makefolder("DemoreHubScripts") end
			writefile("DemoreHubScripts/"..name, code)
		end)
		pcall(function()
			module:AddScriptTabSave(name, code)
		end)
...
local function C_84()
	...
	local ok, files = pcall(listfiles, "DemoreHubScripts")
	if ok and files then
		for index, value in pairs(files) do
			if isfile(value) then
				task.wait(0.03)
				local editedString = value:gsub("DemoreHubScripts[/\\]", "")
				pcall(function()
...
local function C_92()
	...
	script.Parent.savescript.MouseButton1Up:Connect(function()
		local module = require(script.Parent.Parent.Module)
		local path = script.Parent.scriptname.Text
		if path and path ~= "" and isfile(path) then
			local content = readfile(path)
			local base = path:match("([^/\\]+)$") or path
			script.Parent.Visible = false
			script.Parent.scriptname.Text = ""
			module:AddTab(base, content)
		else
			-- also try DemoreHubScripts/
			local alt = "DemoreHubScripts/" .. (path or "")
			if path and path ~= "" and isfile(alt) then
				local content = readfile(alt)
				local base = path:match("([^/\\]+)$") or path
				script.Parent.Visible = false
				script.Parent.scriptname.Text = ""
				module:AddTab(base, content)
			else
				script.Parent.Title.Text = "Demore Hub - Open File (File not found!)"
				task.wait(1)
				script.Parent.Title.Text = "Demore Hub - Open File"
			end
		end
	end)
